...
export function StoreHome() {
  ...
  return (
    <div className="w-full fade-in font-sans bg-background pb-0">
        ...
        <section className="relative w-full rounded-3xl overflow-hidden mb-12 lg:mb-16 shadow-xl border border-zinc-100 dark:border-zinc-800 bg-gradient-to-br from-[#faf8f5] to-[#f3f0ea] lg:min-h-[480px] flex flex-col lg:flex-row">
          ...
          <div className="relative z-20 w-full lg:w-[50%] p-5 md:p-10 lg:p-16 flex flex-col justify-between h-full">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl text-foreground mb-3 lg:mb-5 tracking-tight leading-[1.05] flex flex-wrap items-baseline gap-x-2 lg:gap-x-3">
              ...
              <p className="text-muted-foreground text-xs md:text-base mb-5 lg:mb-8 max-w-sm leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-2 lg:flex lg:flex-wrap items-center gap-y-3 gap-x-2 lg:gap-6 pt-4 lg:pt-5 border-t border-zinc-200 dark:border-zinc-800/60">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] lg:text-[9px] font-bold text-foreground uppercase tracking-widest">Tendencias</span>
                  <span className="text-[8px] lg:text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Exclusivas</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-full bg-store-primary/10 flex items-center justify-center shrink-0">
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] lg:text-[9px] font-bold text-foreground uppercase tracking-widest">Calidad</span>
                  <span className="text-[8px] lg:text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Premium</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-full bg-store-primary/10 flex items-center justify-center shrink-0">
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] lg:text-[9px] font-bold text-foreground uppercase tracking-widest">Pago 100%</span>
                  <span className="text-[8px] lg:text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Seguro</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-full bg-store-primary/10 flex items-center justify-center shrink-0">
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] lg:text-[9px] font-bold text-foreground uppercase tracking-widest">Atención</span>
                  <span className="text-[8px] lg:text-[9px] font-bold text-muted-foreground uppercase tracking-widest">24/7</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-16 mb-12">
        ...
        <div className="mt-16 flex justify-center">
          <Link to={buildUrl("/catalog")} className="inline-flex items-center justify-center bg-card border border-zinc-200 dark:border-zinc-800 hover:border-store-primary hover:text-store-primary text-foreground text-xs font-bold uppercase tracking-widest px-8 py-3.5 rounded-full transition-all">
