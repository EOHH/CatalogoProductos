...
const infoContent: Record<string, { title: string, icon: any, content: React.ReactNode }> = {
  'faq': {
    ...
    content: (
      <div className="space-y-6">
        <div>
          <h3 className="font-bold text-zinc-900 mb-2">¿Cómo puedo realizar un pedido?</h3>
          <p className="text-zinc-600">Puedes explorar nuestro catálogo, agregar los productos que te gusten a tu carrito y al finalizar la compra serás redirigido a WhatsApp para confirmar los detalles del envío y el pago directamente con nuestro equipo.</p>
        </div>
        <div>
          <h3 className="font-bold text-zinc-900 mb-2">¿Venden al por mayor?</h3>
          <p className="text-zinc-600">Sí, ofrecemos precios especiales para compras mayoristas. Por favor, contáctanos a través de WhatsApp para brindarte nuestro catálogo con precios al por mayor y condiciones.</p>
        </div>
        <div>
          <h3 className="font-bold text-zinc-900 mb-2">¿Tienen tienda física?</h3>
          <p className="text-zinc-600">Por el momento operamos como una tienda 100% online, lo que nos permite ofrecerte precios muy competitivos y envíos a todo el país.</p>
        </div>
      </div>
    )
  },
  'shipping': {
    ...
    content: (
      <div className="space-y-6">
        <div>
          <h3 className="font-bold text-zinc-900 mb-2">Políticas de Envío</h3>
          <p className="text-zinc-600 mb-2">Realizamos envíos a todo el país a través de agencias seguras y courier privado. Los tiempos estimados son:</p>
        ...
        <div>
          <h3 className="font-bold text-zinc-900 mb-2">Cambios y Devoluciones</h3>
          <p className="text-zinc-600">Aceptamos cambios dentro de los primeros 7 días de recibido el producto, siempre y cuando este se encuentre en perfectas condiciones, con sus etiquetas originales y sin signos de uso. Los costos de envío por cambios de talla son asumidos por el cliente.</p>
        </div>
      </div>
    )
  },
  'payment': {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-zinc-600">Para tu comodidad y seguridad, aceptamos los siguientes métodos de pago:</p>
        ...
        <p className="text-zinc-600 mt-4 text-sm bg-zinc-50 p-4 rounded-lg">
  ...
  'privacy': {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-zinc-600">Tu privacidad es muy importante para nosotros. En esta tienda respetamos la confidencialidad de tus datos.</p>
        <h3 className="font-bold text-zinc-900 mt-4 mb-2">Uso de la Información</h3>
        <p className="text-zinc-600">La información personal que nos proporciones (nombre, teléfono, correo, dirección) será utilizada exclusivamente para procesar tus pedidos, coordinar entregas y, si lo autorizas, enviarte promociones exclusivas.</p>
        <h3 className="font-bold text-zinc-900 mt-4 mb-2">Seguridad</h3>
        <p className="text-zinc-600">No compartimos, vendemos ni alquilamos tu información personal a terceros bajo ninguna circunstancia. Toda conversación de compra realizada por WhatsApp se maneja con total discreción.</p>
      </div>
    )
  },
  'terms': {
...
export function StoreInfoView() {
  ...
  return (
    <div className="w-full bg-[#fcf9f9] min-h-screen py-10 fade-in">
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-zinc-500 mb-8 font-medium">
          ...
          <span className="text-zinc-800">{currentTopic.title}</span>
        </nav>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-zinc-100">
          <div className="flex items-center gap-4 mb-8 border-b border-zinc-100 pb-6">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-serif text-zinc-900 tracking-tight">
                {currentTopic.title}
              </h1>
