  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Configura los colores de tu tienda y mira los cambios en tiempo real en tu Storefront.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 pb-6 border-b border-zinc-200 dark:border-zinc-800">
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">Recomendado: 512x512px. Máximo 2MB. Tienes un límite de 3 cambios permitidos.</p>
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-md border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex items-center justify-center overflow-hidden">
                  {logoUrl ? (
                ...
                <div className="flex-1">
                  <input
                    ...
                    className="block w-full text-sm text-muted-foreground
                      ...
                      file:bg-zinc-100 dark:bg-zinc-800 file:text-zinc-700
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">El icono pequeño que aparece en la pestaña del navegador. Formato .ico o .png (Máx 2MB).</p>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex items-center justify-center overflow-hidden">
                  {faviconUrl ? (
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <span className="text-sm text-muted-foreground">O ingresa un código HEX personalizado:</span>
              <div className="flex items-center border border-zinc-300 dark:border-zinc-700 rounded-md overflow-hidden">
                <input
                  type="color"
                  value={primaryColor}
        ...
        <div className="flex justify-center items-center bg-zinc-50 dark:bg-zinc-900/50 p-8 rounded-2xl border border-zinc-100 dark:border-zinc-800">
          <div className="relative w-[320px] h-[650px] bg-white rounded-[3rem] shadow-2xl border-[8px] border-zinc-900 overflow-hidden ring-1 ring-zinc-900/10">
            ...
            <div className="h-full w-full flex flex-col bg-zinc-50 dark:bg-zinc-900/50 relative z-10 pt-8">
              ...
              <div className="px-5 mt-6 mb-8">
                ...
                <p className="text-sm text-muted-foreground mb-4">Descubre los estilos más recientes seleccionados para ti.</p>
                <button 
