...
-- ==============================================================================
-- 00018_patch_catalog_tags.sql
-- Fixes missing tags field in get_public_catalog RPC
-- ==============================================================================
...
BEGIN
    ...
    -- Se agregaron los campos social_instagram, social_facebook, social_tiktok
    SELECT id, tenant_id, store_name, description, contact_email, phone, address, currency, locale, timezone, social_instagram, social_facebook, social_tiktok, created_at, updated_at
    INTO v_settings 
    ...
    FROM (
        SELECT 
            ...
            p.sku, p.price, p.compare_at_price, p.featured, p.position, p.tags, p.created_at,
            (
